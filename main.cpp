			...
			case 1:
				...
				switch (opcion) {
					...
					case 2:
						...
						cin>>longitudcuerno;
						//Triceraptor* h = new Triceraptor(nombredinosaurio,alturadinosaurio,pesodinosaurio,fechacreacion,sexodinosaurio,longituddinosaurio,tipoherviboro,incisivos,longitudcuerno);
						//ListDino.push_back(h);
						break;
					case 3:
						cout<<"OMNIVOROS"<<endl;
